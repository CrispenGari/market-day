    ...
    >
      <BottomSheetView style={{ flex: 1 }}>
        ...
        >
          ...
          <Text style={styles.text}>
            2. Not even Mzansi Mart can read or access your messages – we don’t
          ...
          <Text style={styles.text}>
            4. By using Mzansi Mart, you agree to protect your account and
            device. We do our part – you do yours 💪.
          </Text>
        </View>
      </BottomSheetView>
    </BottomSheetModal>
